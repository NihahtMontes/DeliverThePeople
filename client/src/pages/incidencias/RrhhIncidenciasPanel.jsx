...
export default function RrhhIncidenciasPanel() {
  ...
  const [loading, setLoading] = useState(esGestor)
  ...
  return (
    <div className="space-y-6">
      ...
      </> : <div className="glass-card p-8 text-center"><ShieldAlert className="mx-auto text-orange-500" size={36} /><h2 className="mt-4 text-xl font-extrabold text-gray-800">Canal confidencial de RRHH</h2><p className="mx-auto mt-2 max-w-lg text-sm text-gray-500">Puedes reportar una incidencia vinculada a tu usuario y sucursal. El seguimiento global corresponde a administración y gerencia.</p><button onClick={abrirForm} className="mt-6 rounded-xl bg-orange-600 px-5 py-2.5 text-sm font-bold text-white">Crear reporte</button></div>}
